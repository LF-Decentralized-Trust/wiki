...
5. [2022-Q4](2022-Q4_21660829.html)

# Hyperledger Cello : 2022-12-10

Created by Baohua Yang, last modified on Dec 09, 2022
...
- **PR this week**
  ...
  - [https://github.com/hyperledger/cello/pull/503](https://github.com/hyperledger/cello/pull/503)
- **Release plan 1.0.0 GA  Q4 of 2022**
  ...
  - channel: [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence)
    ...
    - **download the config block file (peer channel fetch config businesschannel\_cfg.block -c ${APP\_CHANNEL} -o orderer:7050)**. config-export → latest config json file: 2pw
      ...
      - TODO: Add a **download JSON config** menu item for the channel. [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence)
    - Add new org MSP Json into channel. [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) [https://github.com/hyperledger/cello/pull/490](https://github.com/hyperledger/cello/pull/490)
      ...
      - TODO: Add a button + upload-file dialogue [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence)will help this
...
- [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) has contacted community for potential VM resource. sent email to [community-architects@hyperledger.org](mailto:community-architects@hyperledger.org).
  
  - Got replied, we need to create an issue for requesting VMs from CNCF, here is the link for that issue [https://github.com/cncf/cluster/issues/221](https://github.com/cncf/cluster/issues/221), feel free to leave comments.
- [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence) suggests the api-engine not check the token when the register/login API is called.  Will create an issue for [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence)
  
  - The auth header is included even logout. [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence)
    
    - [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence)will check if can disable the token checking at API-Engine backend for the register API.
      
      - register API does not check the token
  - [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence)will check whether the token is checked at the Register API.
  - [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence)continues working on this, worst case is 1~2 weeks.
  - [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence)will help change the front end code.
- 1.0-beta1 is out. 1.0-GA is targeted this December, and [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence)is the QA manager.
- [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence) [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) when login in, why needs to click login in button twice. Reported by [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence) .
  
  - [https://github.com/hyperledger/cello/issues/500](https://github.com/hyperledger/cello/issues/500)
- Documentation Improvement: [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) will start to review.
- QA Progress: [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence) will start at the end of Dec.
- Will cancel the following 3 weeks' meetings.
- Backlogs:
