...
# Hyperledger Cello : 2021-06-12

Created by Baohua Yang, last modified on Jun 11, 2021
...
- - Feedbacks on the presentation of Cello at HGF (June 8~10, virtual/zoom). Feedbacks on attending HGF.
    
    - ~15 attendees, a quick presentation with demo
    - baohua attend several sessions: ~40 attendees
  - The internship project [Operate Blockchain Network in an Efficient Way](https://lf-hyperledger.atlassian.net/wiki/spaces/INTERN/pages/21954719/Operate+Blockchain+Network+in+an+Efficient+Way): [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence)is the intern for 2021.
    
    - Weekly sync-up: joined github org; read docker agent code; draft the plan.
    - Plan review: [Project Plan - Operate Blockchain Network in an Efficient Way](https://lf-hyperledger.atlassian.net/wiki/spaces/INTERN/pages/21964727/Project+Plan+-+Operate+Blockchain+Network+in+an+Efficient+Way)
  - PRs got merged:
    
    - [https://github.com/hyperledger/cello/pull/250](https://github.com/hyperledger/cello/pull/250)
  - TSC quarterly report is done by [qiang xu](https://lf-hyperledger.atlassian.net/wiki/people/712020:d143b60e-255e-4a7d-bdc5-9aa41dafc74a?ref=confluence) : [2021 Project Updates](https://lf-hyperledger.atlassian.net/wiki/spaces/TSC/pages/21452543/2021+Project+Updates)
    
    - remaining issue: branch name: master → main; add repolinter.json: [Common Repo structure](https://lf-hyperledger.atlassian.net/wiki/spaces/TSC/pages/21437289/Common+Repo+structure). [Dixing Xu](https://lf-hyperledger.atlassian.net/wiki/people/557058:cd50c900-e1ff-4489-b6ea-bbeeced4eb6d?ref=confluence)
  - Port map need to be passed to the agent: see port-map in [![](plugins/servlet/confluence/placeholder/unknown-macro)](https://docs.google.com/document/d/1XwkUORuySV2uDo1tl2e3SA3RPwrsKCoVplqmmKiK9N0/edit). [Dixing Xu](https://lf-hyperledger.atlassian.net/wiki/people/557058:cd50c900-e1ff-4489-b6ea-bbeeced4eb6d?ref=confluence)
  - Backlogs:
...
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660498/21660499.txt) (text/plain)
