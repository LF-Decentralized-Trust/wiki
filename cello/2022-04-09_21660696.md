...
# Hyperledger Cello : 2022-04-09

Created by Baohua Yang, last modified on Apr 08, 2022
...
- PR this week
  ...
  - [https://github.com/hyperledger/cello/pull/427](https://github.com/hyperledger/cello/pull/427)
  - [https://github.com/hyperledger/cello/pull/433](https://github.com/hyperledger/cello/pull/433)
...
- Release plan
  ...
  - 1.0.0-alpha2 (end of April):  
    
    - user: update (password): 1pw
    - channel: add org into network/channel, config-export: 2pw
    - node: create, start, stop, delete (delete the node own info from DB; dashboard will pop a warning dialog [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence) ), query, update (config file): 1pw
      
      - [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence): use volume to map container data to VM local path. [https://github.com/hyperledger/cello/pull/425](https://github.com/hyperledger/cello/pull/425)
        
        - config file (local-file:container-file)
        - msp (/etc/hyperledger/fabric/)
        - ledger data (/var/hyperledger/production/)
        - chaincode (peer-only)
      - node list returns the node status (creating/deploying, running, stopped): [https://github.com/hyperledger/cello/pull/433](https://github.com/hyperledger/cello/pull/433)
...
- [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence): 
  ...
  - [https://github.com/hyperledger/cello/issues/429](https://github.com/hyperledger/cello/issues/429)
  - [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence)found an "invalid signature" issue, which may caused by adding auth headers when registering users (suggest by [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) ).
...
export PATH=$PATH:/usr/local/go/bin
    ```
- Mentorship project is approved! [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence)
...
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660696/21660698.txt) (text/plain)  
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660696/21660697.txt) (text/plain)
