...
# Hyperledger Cello : 2021-12-18

Created by Baohua Yang, last modified on Dec 17, 2021
...
- 1.0.0-alpha: finish user/agent/node features
- 1.0.0-GA: deployment + major operations
- Next week: do we have the last meeting this year or just skip?
...
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660618/21660620.txt) (text/plain)  
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660618/21660619.txt) (text/plain)
