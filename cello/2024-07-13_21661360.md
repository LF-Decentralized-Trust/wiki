...
# Hyperledger Cello : 2024-07-13

Created by Baohua Yang, last modified on Jul 18, 2024
...
- [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) : python lib for fabric cli call, change backend to plugin(RPC Call with Go), FE → BE(business logic, Django) → **RPC Server(Go)** → fabric cli call(Go pkg).
- [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence) and [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) are absent today.
- [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence) :  working with [Xiao Ran](https://lf-hyperledger.atlassian.net/wiki/people/712020:e2e739f3-bcc0-4fa4-86e2-e807f7631c72?ref=confluence) for the install issue: [https://github.com/hyperledger/cello/issues/621](https://github.com/hyperledger/cello/issues/621). Run commands with peer cli.
- [Xiao Ran](https://lf-hyperledger.atlassian.net/wiki/people/712020:e2e739f3-bcc0-4fa4-86e2-e807f7631c72?ref=confluence) : Reading BE code. [Chaincode v2 API Spec](Chaincode-v2-API-Spec_21660919.html). Check the Approve API, learn to run fabric peer client.
  ...
  - Install still has issues, will recheck. [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence) help. Fixed node version, django dependency issue.
- Welcome Haibo Yang and [haoyu li](https://lf-hyperledger.atlassian.net/wiki/people/712020:83c6fcb8-2306-4cbe-9413-926387f98ae8?ref=confluence) : create wiki account, join github id to hyperledger team → cello org. [https://github.com/hyperledger/cello](https://github.com/hyperledger/cello)
- LFDT is revising the charter for each project. Please help review and see if there's any comment:
...
- [Haibo Yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:71dd8120-10d6-497c-bbef-fec7745ea71f?ref=confluence) Intern plan: [Project Plan - Decentralized Blockchain Network Operation Dashboard](https://lf-hyperledger.atlassian.net/wiki/spaces/INTERN/pages/21960875/Project+Plan+-+Decentralized+Blockchain+Network+Operation+Dashboard)
  
  - Docker image for HLF v2.5 (latest is v2.5.9): update all required images
  - [https://github.com/hyperledger/cello/pull/627](https://github.com/hyperledger/cello/pull/627): Suggest upgrade node.js to 20+, lots of changes are needed.
...
- New Fabric Cli RPC Server [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) 
  ...
  - Questions:
    ...
    - API Engine can use restful API to call the fabric operator?
