...
# Hyperledger Cello : 2022-09-03

Created by Baohua Yang, last modified on Sep 02, 2022
...
- **PR this week**
  ...
  - [https://github.com/hyperledger/cello/pull/485](https://github.com/hyperledger/cello/pull/485)
- **Release plan 1.0.0-beta1 Q3 of 2022**
  ...
  - node: [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence) 
    ...
    - Peer join channel. Upload a genesis block file of the channel (peer join channel with the genesis block of the channel: peer channel join -b ${APP\_CHANNEL}.block)
...
- Next week is mid-autumn festival, will cancel.
- Backlogs:
