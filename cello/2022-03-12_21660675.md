...
# Hyperledger Cello : 2022-03-12

Created by Baohua Yang, last modified on Mar 11, 2022
...
- PR this week
  ...
  - [https://github.com/hyperledger/cello/pull/420](https://github.com/hyperledger/cello/pull/420)
...
- Release plan
  ...
  - 1.0.0-alpha2 (end of Mar):  
    ...
    - node: start, stop, delete (node own info; dashboard will pop a warning dialog), query, update (config file): 1pw
      ...
      - [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence): use volume to map container data to VM local path.
        ...
        - ledger data
        - chaincode
      - node status: created/started/stopped: [https://github.com/hyperledger/cello/pull/420](https://github.com/hyperledger/cello/pull/420)
...
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660675/21660677.txt) (text/plain)  
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660675/21660676.txt) (text/plain)
