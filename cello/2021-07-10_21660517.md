...
# Hyperledger Cello : 2021-07-10

Created by Baohua Yang, last modified on Jul 09, 2021
...
- - Qiang Xu and Yang Feng is working on debugging the console code.
    ...
    - Can register and login now (1 week);
    - TODO: the known challenge is the login function;
  ...
  - [Baohua Yang](https://lf-hyperledger.atlassian.net/wiki/people/557058:17d87dbf-05fe-4c1b-84cf-fd69f7fcbb20?ref=confluence)  evaluated the 1st phase of intern program.
  - [https://github.com/hyperledger/cello/pull/266](https://github.com/hyperledger/cello/pull/266)
  - The [internship project](https://lf-hyperledger.atlassian.net/wiki/display/INTERN/Operate+Blockchain+Network+in+an+Efficient+Way) weekly sync up
    ...
    - TODO: [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) help evaluate the dependency on umi.js.
  - Other issues?
  - Backlogs:
...
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660517/21660518.txt) (text/plain)
