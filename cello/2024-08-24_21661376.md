...
# Hyperledger Cello : 2024-08-24

Created by Baohua Yang, last modified on Aug 23, 2024
...
- [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) : on leave, working on [https://github.com/hyperledger/cello/pull/629/files](https://github.com/hyperledger/cello/pull/629/files).
...
- Intern plan: [Project Plan - Decentralized Blockchain Network Operation Dashboard](https://lf-hyperledger.atlassian.net/wiki/spaces/INTERN/pages/21960875/Project+Plan+-+Decentralized+Blockchain+Network+Operation+Dashboard)
  ...
  - [Haibo Yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:71dd8120-10d6-497c-bbef-fec7745ea71f?ref=confluence): 
    ...
    - [https://github.com/hyperledger/cello/pull/630](https://github.com/hyperledger/cello/pull/630)
    - [https://github.com/hyperledger/cello/pull/631](https://github.com/hyperledger/cello/pull/631)
...
- Wiki issue of permission error: contact ry &lt;[rjones@linuxfoundation.org](mailto:rjones@linuxfoundation.org)&gt;
