...
# Hyperledger Cello : 2021-10-09

Created by Baohua Yang, last modified on Oct 08, 2021
...
- PR this week
  ...
  - [https://github.com/hyperledger/cello/pull/328](https://github.com/hyperledger/cello/pull/328): need review
  - [https://github.com/hyperledger/cello/pull/336](https://github.com/hyperledger/cello/pull/336): TODO: [qiang xu](https://lf-hyperledger.atlassian.net/wiki/people/712020:d143b60e-255e-4a7d-bdc5-9aa41dafc74a?ref=confluence) suggest create a base image to include all needed tools.
...
- The [internship project](https://lf-hyperledger.atlassian.net/wiki/display/INTERN/Operate+Blockchain+Network+in+an+Efficient+Way) weekly sync up
  ...
  - TODO: demo the workflow next weeks.
- TODO: [zhao shihong](https://lf-hyperledger.atlassian.net/wiki/people/712020:4dd84a5e-3c58-4c0b-9e86-f993e85b5961?ref=confluence)
  ...
  - TODO: demo the workflow next weeks.
- TSC annual election: contact [rjones@linuxfoundation.org](mailto:rjones@linuxfoundation.org) if you have not received a voting ticket link yet.
- Backlogs:
