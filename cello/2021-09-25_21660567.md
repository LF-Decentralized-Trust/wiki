...
# Hyperledger Cello : 2021-09-25

Created by Baohua Yang, last modified on Sep 24, 2021
...
- PR this week
  ...
  - [https://github.com/hyperledger/cello/pull/324](https://github.com/hyperledger/cello/pull/324)
  - [https://github.com/hyperledger/cello/pull/325](https://github.com/hyperledger/cello/pull/325)
  - [https://github.com/hyperledger/cello/pull/327](https://github.com/hyperledger/cello/pull/327)
  - [https://github.com/hyperledger/cello/pull/328](https://github.com/hyperledger/cello/pull/328)
- Qiang Xu and Yang Feng is working on developing the dashboard code.
  
  - Revise the dashboard work
  - Contact [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) to help fix the issue of finding the correct msp path. The issue is fixed.
- The [internship project](https://lf-hyperledger.atlassian.net/wiki/display/INTERN/Operate+Blockchain+Network+in+an+Efficient+Way) weekly sync up
  ...
  - TODO: demo the workflow after two weeks.
- TODO: [zhao shihong](https://lf-hyperledger.atlassian.net/wiki/people/712020:4dd84a5e-3c58-4c0b-9e86-f993e85b5961?ref=confluence)
  ...
  - Write a py lib spec:
    ...
    - chaincode: new 2.2 chaincode lifecycle (package, install, approve, commit, queries-methods). 
      
      - Finished package, install, approve, query-approved, query-installed
      - ETA: 1~2 weeks.
  ...
  - TODO: demo the workflow after two weeks.
- Cancel next week due to national holidays? (Oct 1~Oct 7)
- Backlogs:
