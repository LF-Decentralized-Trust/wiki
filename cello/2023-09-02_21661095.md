...
# Hyperledger Cello : 2023-09-02

Created by Baohua Yang, last modified on Sep 01, 2023
...
- **PR this week**
  ...
  - [https://github.com/hyperledger/cello/pull/544](https://github.com/hyperledger/cello/pull/544): [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) will improve the code to let demo be a full registered user
  - [https://github.com/hyperledger/cello/pull/546](https://github.com/hyperledger/cello/pull/546)
- **Release 1.0.0**
...
- Intern Students Updates (everyone should join [hyperledger org](https://github.com/hyperledger) at github first):
  ...
  - Haowen Pan: Reading django and fabric. Improve docker compose with depends\_on and healthcheck: [https://docs.docker.com/compose/compose-file/05-services/#healthcheck](https://docs.docker.com/compose/compose-file/05-services/#healthcheck)
  - Xiao Ran: Reading [hlf](https://hlf.readthedocs.io/en/latest/) docs first and run some local chaincode, reading django. [https://github.com/yeasy/docker-compose-files/tree/master/hyperledger\_fabric](https://github.com/yeasy/docker-compose-files/tree/master/hyperledger_fabric)
  - Yun Gu: Run hlf testnet, Reading django . [https://github.com/yeasy/docker-compose-files/tree/master/hyperledger\_fabric](https://github.com/yeasy/docker-compose-files/tree/master/hyperledger_fabric). Need advisor from backend. [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence) will help, [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) as backup.
- Q3 report: [https://github.com/hyperledger/cello/issues/549](https://github.com/hyperledger/cello/issues/549?notification_referrer_id=NT_kwDOAB1ONLI3NTE1Nzk4ODA2OjE5MjA1NjQ&notifications_query=is%3Aunread), [https://github.com/hyperledger/toc/tree/gh-pages/project-reports/2023](https://github.com/hyperledger/toc/tree/gh-pages/project-reports/2023) [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) will update.
- Others
