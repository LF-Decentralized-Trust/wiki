...
# Hyperledger Cello : 2021-11-13

Created by Baohua Yang, last modified on Nov 12, 2021
...
- PR this week
  ...
  - [https://github.com/hyperledger/cello/pull/342](https://github.com/hyperledger/cello/pull/342) (merged)
  - [https://github.com/hyperledger/cello/pull/343](https://github.com/hyperledger/cello/pull/343) (need to split into sub tasks)
- Qiang Xu and Yang Feng is working on developing the dashboard code.
  ...
  - TOOD: yang feng is waiting for backend API (channel related)
- The [internship project](https://lf-hyperledger.atlassian.net/wiki/display/INTERN/Operate+Blockchain+Network+in+an+Efficient+Way) weekly sync up
  ...
  - Demoed the workflow, have [dummyfile.txt](#). [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence)please refer to it.
- TODO: [zhao shihong](https://lf-hyperledger.atlassian.net/wiki/people/712020:4dd84a5e-3c58-4c0b-9e86-f993e85b5961?ref=confluence)
  ...
  - TODO: API-engine's chaincode API implementation: [https://docs.qq.com/doc/DUG5lamp2Z1JFeWh6](https://docs.qq.com/doc/DUG5lamp2Z1JFeWh6).
  - Demoed the workflow, have r[dummyfile.txt](#).
- Backlogs:
...
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660590/21660595.txt) (text/plain)  
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/21660590/21660593.txt) (text/plain)
