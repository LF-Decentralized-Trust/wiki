...
# Hyperledger Cello : 2021-11-06

Created by Baohua Yang, last modified on Nov 05, 2021
...
- The [internship project](https://lf-hyperledger.atlassian.net/wiki/display/INTERN/Operate+Blockchain+Network+in+an+Efficient+Way) weekly sync up
  ...
  - TODO: demo the workflow, delay to the next week. Fix channel creation issue.
- fengyang: console workflow design
