...
# Hyperledger Cello : 2024-07-20

Created by Baohua Yang, last modified on Jul 19, 2024
...
- [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) : python lib for fabric cli call, change backend to plugin(RPC Call with Go), FE → BE(business logic, Django) → **RPC Server(Go, SDK server, use RESTful API first)** → fabric cli call(Go pkg).
- [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence) and [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence) + [haoyu li](https://lf-hyperledger.atlassian.net/wiki/people/712020:83c6fcb8-2306-4cbe-9413-926387f98ae8?ref=confluence)  are absent today.
...
- Welcome [Haibo Yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:71dd8120-10d6-497c-bbef-fec7745ea71f?ref=confluence)  and [haoyu li](https://lf-hyperledger.atlassian.net/wiki/people/712020:83c6fcb8-2306-4cbe-9413-926387f98ae8?ref=confluence) : create wiki account, join github id to hyperledger team → cello org. [https://github.com/hyperledger/cello](https://github.com/hyperledger/cello)
