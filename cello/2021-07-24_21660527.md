...
# Hyperledger Cello : 2021-07-24

Created by qiang xu, last modified by Baohua Yang on Jul 23, 2021
...
- Qiang Xu and Yang Feng is working on debugging the console code.
  ...
  - DONE: agent lifecycle management: create, delete
  - [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence): how to boot up the backend services quickly? Currently using mock APIs.
    ...
    - Make agent a container, [qiang xu](https://lf-hyperledger.atlassian.net/wiki/people/712020:d143b60e-255e-4a7d-bdc5-9aa41dafc74a?ref=confluence)
...
- PR to review
  ...
  - [https://github.com/hyperledger/cello/pull/271](https://github.com/hyperledger/cello/pull/271)
  - [https://github.com/hyperledger/cello/pull/272](https://github.com/hyperledger/cello/pull/272)
    
    - Blockchain network resources: channel, org, node, chaincode
    - Create channel: using peer CLI: [https://hlf.readthedocs.io/en/latest/commands/peerchannel.html](https://hlf.readthedocs.io/en/latest/commands/peerchannel.html)
    - Chaincode invocation: SDK
- The [internship project](https://lf-hyperledger.atlassian.net/wiki/display/INTERN/Operate+Blockchain+Network+in+an+Efficient+Way) weekly sync up
  ...
  - Got familiar with the API-engine part and dashboard part;
  - TODO: Start working on API-engine part next week.
    
    - Channel creation, update, query.
