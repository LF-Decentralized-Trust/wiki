...
# Hyperledger Cello : 2021-08-28

Created by Baohua Yang, last modified on Aug 27, 2021
...
- PR this week
  ...
  - [https://github.com/hyperledger/cello/pull/303](https://github.com/hyperledger/cello/pull/303)
  - [https://github.com/hyperledger/cello/pull/304](https://github.com/hyperledger/cello/pull/304)
  - [https://github.com/hyperledger/cello/pull/306](https://github.com/hyperledger/cello/pull/306)
  - [https://github.com/hyperledger/cello/pull/307](https://github.com/hyperledger/cello/pull/307)
- Qiang Xu and Yang Feng is working on developing the dashboard code.
  ...
  - The creation of agent was unsuccessful, and there were many requests for organization lists on the page.@fengyang
    ...
    - API engine does not work, will contact [qiang xu](https://lf-hyperledger.atlassian.net/wiki/people/712020:d143b60e-255e-4a7d-bdc5-9aa41dafc74a?ref=confluence)after the meeting;
...
- Set default channel Admin policy from Majority to the creator of the channel. [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence)
