...
# Hyperledger Cello : 2022-10-29

Created by Baohua Yang, last modified on Oct 28, 2022
...
- **PR this week**
  ...
  - [https://github.com/hyperledger/cello/pull/490](https://github.com/hyperledger/cello/pull/490)
...
- **Release plan 1.0.0-beta1 Q3 of 2022**
  ...
  - channel: [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence)
    ...
    - **download the config block file (peer channel fetch config businesschannel\_cfg.block -c ${APP\_CHANNEL} -o orderer:7050)**. config-export → latest config json file: 2pw
      ...
      - TODO: add a **download config** menu item for the channel. [Xichen Pan](https://lf-hyperledger.atlassian.net/wiki/people/712020:1085087f-f6a8-47ad-b5ae-b985d6152460?ref=confluence)
    - Add new org MSP Json into channel. [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) [https://github.com/hyperledger/cello/pull/490](https://github.com/hyperledger/cello/pull/490)
      ...
      - This PR is blocked, it is hard to upload a file and add JSON data at the same time.
        
        May need to refine the design of the request body,
        
        e.g. copy/paste the config file in plain text format, then send the request in JSON format data instead of files.
      - Possible solutions:
        
        - Convert files to base64 format and send them to the backend in a string format.
          
          [feng yang](https://lf-hyperledger.atlassian.net/wiki/people/712020:23894469-5964-413e-bde8-8baa9f37d28d?ref=confluence) said it should be ok to use json file upload+request body.
...
- TOC election nomination will close on October 31 (send to [election-2022@hyperledger.org](mailto:election-2022@hyperledger.org)). Election is Nov 1~Nov 30.
- Backlogs:
