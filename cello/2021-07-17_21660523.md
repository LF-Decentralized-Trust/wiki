...
# Hyperledger Cello : 2021-07-17

Created by Baohua Yang, last modified by qiang xu on Jul 20, 2021
...
- Qiang Xu and Yang Feng is working on debugging the console code.
  ...
  - Finish works of register and login now;
  - TODO: create agent
...
- The [internship project](https://lf-hyperledger.atlassian.net/wiki/display/INTERN/Operate+Blockchain+Network+in+an+Efficient+Way) weekly sync up
  ...
  - [Yuanmao Zhu](https://lf-hyperledger.atlassian.net/wiki/people/712020:6a1ab58c-74d8-45f1-ad1c-4fc227eb20cf?ref=confluence) help evaluate the dependency on umi.js.
    
    - umi.js is widely used currently, similar as npm for react, can simplify redux;
    - dashboard depends on umi to fetch data, route;
    - Conclusion: continue to use umi.js
    - TBD: umi.js is not popular in US and EU
  - TODO: Start working on API-engine part next week.
    
    - Channel creation, update, query. TODO: backend need to decide to use which SDK, or CLI.
- Discuss issues Using CA to replace cryptogen tool to generate certificate
  
  - [https://github.com/hyperledger/cello/issues/268](https://github.com/hyperledger/cello/issues/268)
  - [https://github.com/hyperledger/cello/issues/269](https://github.com/hyperledger/cello/issues/269)
- Backlogs:
