...
# Hyperledger Fabric : Release Exit Criteria
...
- zero [high or highest priority bugs](https://jira.hyperledger.org/secure/Dashboard.jspa?selectPageId=10104#Issue-Statistics/10477) remain open,
...
- release has met all the criteria for [CII Best Practices Badge](https://bestpractices.coreinfrastructure.org/) Best Practices Badge,
...
- signed release code (not sha1, which is what git currently uses as that is no longer secure), published images ([DTR](https://docs.docker.com/datacenter/dtr/2.1/guides/)) and binaries,
- future goal - automated release notes similar to those published by mature open source projects such as Kubernetes, or [Cloud Foundry](https://github.com/cloudfoundry/cf-release/releases)
