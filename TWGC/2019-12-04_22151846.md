...
# Technical Working Group China : 2019-12-04

Created by david liu, last modified by Yong Wan on Dec 17, 2019

![](attachments/22151846/22151847.png?height=150) ![](attachments/22151846/22151848.png?height=150)
...
2. [Team i18n and Education](https://lf-hyperledger.atlassian.net/wiki/display/TWGC/i18n+and+Education) ([Zhenhua Zhao](https://lf-hyperledger.atlassian.net/wiki/people/5da669613c95d00c3c649d6e?ref=confluence) [郭立冬](https://lf-hyperledger.atlassian.net/wiki/people/6183eb45bcb574006810d17f?ref=confluence) [Yang Cheng](https://lf-hyperledger.atlassian.net/wiki/people/712020:4461a0ca-7fe6-4b0c-9a5e-2eb1d121e60a?ref=confluence) )
   ...
   2. Documentation Fabric 1.4.2 is released
   3. 翻译自Dave Enyeart对于上次contributor meeting的讨论以及相关的邮件总结
      
      - 会上达成了普遍的共识：除非有非常有说服力的理由，fabric的文档不应该从代码仓库中分离出来
      
      - 我们希望之前在邮件线上提出的所有问题都应该通过不切分Fabric文档的方式来解决
      
      - 下一步，文档团队会提出一个工作流程，以达到如下目的：Fabric主仓库中的文档内容（包括多语言的部分），在不需要新的专职文档/翻译项目维护者条件下依然可以发布出来
   4. 继续使用Github，或探索Transifex工作流程？
...
4. [Team Event Organization](https://lf-hyperledger.atlassian.net/wiki/display/TWGC/Events+Organization) ([J Guo](https://lf-hyperledger.atlassian.net/wiki/people/70121:6a297646-8eaf-48bb-afd9-76ce748a10eb?ref=confluence) , [Zhenhua Zhao](https://lf-hyperledger.atlassian.net/wiki/people/5da669613c95d00c3c649d6e?ref=confluence) [Scott Long](https://lf-hyperledger.atlassian.net/wiki/people/712020:d1bf34a5-5759-4945-8433-6da36f1c6870?ref=confluence)  )
   ...
   3. Meetups plan for Dec
5. The Hyperledger Fabric Developer (CHFD) exam is scheduled to launch in late Q1 2020 and we are now looking for Beta testers
6. Edmund To from Consensys give introduction talk about [Hyperledger Besu](https://www.hyperledger.org/projects/besu)

# Minutes

1. [Team development and Innovation](https://lf-hyperledger.atlassian.net/wiki/display/TWGC/Development+and+Innovation) [J Guo](https://lf-hyperledger.atlassian.net/wiki/people/70121:6a297646-8eaf-48bb-afd9-76ce748a10eb?ref=confluence)  [TopJohn](https://lf-hyperledger.atlassian.net/wiki/people/5b417eec10d57114135ec9aa?ref=confluence) , [david liu](https://lf-hyperledger.atlassian.net/wiki/people/557058:ccdd3d2a-7f2a-4159-a2f2-de5fc7776831?ref=confluence) )
   
   1. [FAQ](FAQ_22151261.html)
   2. Hyperledger is moving gerrit base CI to github one. Remains:  \`fabric-test\`
2. [Team i18n and Education](https://lf-hyperledger.atlassian.net/wiki/display/TWGC/i18n+and+Education) ([Zhenhua Zhao](https://lf-hyperledger.atlassian.net/wiki/people/5da669613c95d00c3c649d6e?ref=confluence) [郭立冬](https://lf-hyperledger.atlassian.net/wiki/people/6183eb45bcb574006810d17f?ref=confluence) [Yang Cheng](https://lf-hyperledger.atlassian.net/wiki/people/712020:4461a0ca-7fe6-4b0c-9a5e-2eb1d121e60a?ref=confluence) )
   
   1. [i18n work guideline](https://lf-hyperledger.atlassian.net/wiki/display/TWGC/Guideline)
   2. Documentation Fabric 1.4.2 is released
   3. 继续使用Github is preferred by TWGC documentation volunteers
3. [Team Collaboration and Scenarios](https://lf-hyperledger.atlassian.net/wiki/display/TWGC/Collaborations+and+Scenarios) ([Dorothy Cheng](https://lf-hyperledger.atlassian.net/wiki/people/712020:7e5a518b-9be6-4b40-8450-a804ca93647a?ref=confluence) [Scott Long](https://lf-hyperledger.atlassian.net/wiki/people/712020:d1bf34a5-5759-4945-8433-6da36f1c6870?ref=confluence) ) 
   
   1. Communications: wechat group update
4. [Team Event Organization](https://lf-hyperledger.atlassian.net/wiki/display/TWGC/Events+Organization) ([J Guo](https://lf-hyperledger.atlassian.net/wiki/people/70121:6a297646-8eaf-48bb-afd9-76ce748a10eb?ref=confluence) , [Zhenhua Zhao](https://lf-hyperledger.atlassian.net/wiki/people/5da669613c95d00c3c649d6e?ref=confluence) [Scott Long](https://lf-hyperledger.atlassian.net/wiki/people/712020:d1bf34a5-5759-4945-8433-6da36f1c6870?ref=confluence)  )
   
   1. [Meetup guideline](https://lf-hyperledger.atlassian.net/wiki/display/TWGC/Meetup+guideline)
   2. Every meetup please be placed at the [Team Event Organization](https://lf-hyperledger.atlassian.net/wiki/display/TWGC/Events+Organization)
   3. Meetups plan for Dec
5. The Hyperledger Fabric Developer ([CHFD](https://training.linuxfoundation.org/certification/certified-hyperledger-fabric-developer/)) exam is scheduled to launch in late Q1 2020 and we are now looking for Beta testers
   
   1. Register link is [here](https://docs.google.com/forms/d/e/1FAIpQLScPxgBt6GvuTcrtjYCkWqW2D6o-2YrNd4vR--KXFGUw-5Ctsw/viewform).
   2. For top 20 early bird is free, and for later register the Beta will be available at the low discount of USD $100.
6. Edmund To from Consensys give introduction talk about [Hyperledger Besu](https://www.hyperledger.org/projects/besu)
   
   1. QA section addition
      
      1. About interop between fabric and ethereum, interested people could see [https://github.com/clearmatics/ion](https://github.com/clearmatics/ion) \[Disclaimer] It is not done by Consensys
7. Recording
...
![](images/icons/bullet_blue.gif) [inclusive.png](attachments/22151846/22151848.png) (image/png)  
![](images/icons/bullet_blue.gif) [Antitrustnotice.png](attachments/22151846/22151847.png) (image/png)  
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/22151846/22151871.txt) (text/plain)
