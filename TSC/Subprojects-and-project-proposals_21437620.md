...
# Technical Oversight Committee : Subprojects and project proposals
...
See the [Project Lifecycle Task Force Issue 6](https://lf-hyperledger.atlassian.net/wiki/spaces/TF/pages/20873487/Issue+6+Should+we+have+subprojects+and+fewer+toplevel+projects) Proposed Related Resolution 6.5.
