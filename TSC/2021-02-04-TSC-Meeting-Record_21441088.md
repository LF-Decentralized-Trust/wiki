...
# Technical Oversight Committee : 2021 02 04 TSC Meeting Record
...
- Implementing the [TSC decision on 13 FEB 2020](https://lf-hyperledger.atlassian.net/wiki/display/TSC/Common+Repo+structure) has raised some questions: Which repolint.json config file to use? Should it be part of the project's CI?
