...
# Hyperledger Aries : 2024-02-07 Aries Working Group Call

Created by Sam Curren, last modified by Steve McCown on Feb 07, 2024
...
07 Feb 2024 (7AM Los Angeles, 10AM New York, 3PM London, 4PM CET, 18H Moscow)
...
- DSR Presentation - [Lots of Things Identity](https://www.hyperledger.org/events/decentralized-identity-interoperability-workshop-connecting-besu-cardano-anoncreds-cheqd-and-agent-framework-javascript?hsLang=en) (1 hour after normal aries call, tomorrow)
...
- Annual Report Update – [Draft Aries Report](https://docs.google.com/document/d/1u42q8HzZ7DwK_Nudmfa0T15yCdwUCZ2vRbeXm4U76K8/edit?usp=sharing), [TOC Annual Report Requirements](https://toc.hyperledger.org/governing-documents/project-annual-review.html)
  ...
  - To be discussed by the TOC on 2024.02.15 - Next Thursday - [Event Information](https://lists.hyperledger.org/g/toc/viewevent?repeatid=52670&eventid=2208914&calstart=2024-02-15)
- RFC Status Change
  
  - - [https://github.com/hyperledger/aries-rfcs/pull/811](https://github.com/hyperledger/aries-rfcs/pull/811)
- Unqualified DIDs Update
  ...
  - Credo - Yes (0.5 release)
  - ACA-Py - did:peer:1,2,4 (receiving) 2,4 (emit)
    
    - Remaining work: DID Rotate (Partially done PR, assistance might be helpful - ask Stephen)
  - Bifold - needs Credo 0.5 release
- OID4VC Status
  
  - ACA-Py
    
    - Available Plugin - OID4VCI Draft 11 (Issuance)
      
      - limited to JWT-VC
      - additional work needed for LD-VC, and SD-JWT
      - Also Presentation
  - Credo
    
    - [https://credo.js.org/guides/0.5/features/openid4vc](https://credo.js.org/guides/0.5/features/openid4vc)
      
      - Link includes draft references for support
...
- Aries RFC Repo Rendering Goals/Ideas
- Open Discussion
