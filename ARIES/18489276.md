...
# Hyperledger Aries : 2020-10-28-B Aries Working Group Call (US afternoon)

Created by Sam Curren, last modified on Oct 28, 2020
...
## Date: 28 Oct 2020 (12PM Los Angeles, 3PM New York, Tuesday at 7AM Sydney)
...
- [2020-11-5 Identity Implementers WG Call](https://lf-hyperledger.atlassian.net/wiki/spaces/IWG/pages/18251993/2020-11-5+Identity+Implementers+WG+Call) (9am MT / 3pm UTC) .
...
- Aries-CloudAgent-Python ([bc.gov](http://bc.gov))
  ...
  - Release 0.5.6 is out.
    ...
    - Unified config files (yaml), command line and environment variables
...
- Kiva Mobile App Goodness Demo - Horacio Nunez (Kiva)
- IIW Recap
  
  - Aries Askar (not session name) - Andrew Whitehead
  - Custodial Agents - Sam Curren
- Privacy-preserving proof of uniqueness: [https://github.com/hyperledger/aries-rfcs/pull/559](https://github.com/hyperledger/aries-rfcs/pull/559) (Daniel Hardman)
- MIME types for DIDComm: [https://github.com/decentralized-identity/didcomm-messaging/pull/124](https://github.com/decentralized-identity/didcomm-messaging/pull/124) (Daniel Hardman)
- Feature Discovery
- Closing Game
...
Text File [chat.txt](attachments/18489276/18514296.txt "Download")

Oct 28, 2020 by [Sam Curren](/wiki/people/557058:1ed5fd92-7e42-4cab-87b1-688e48bc02c2)

## Attachments:

![](images/icons/bullet_blue.gif) [chat.txt](attachments/18489276/18514296.txt) (text/plain)  
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/18489276/18514304.txt) (text/plain)  
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/18489276/18514295.txt) (text/plain)
