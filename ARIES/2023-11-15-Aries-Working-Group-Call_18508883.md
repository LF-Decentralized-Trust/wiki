...
# Hyperledger Aries : 2023-11-15 Aries Working Group Call
...
15 Nov 2023 (7AM Los Angeles, 10AM New York, 3PM London, 4PM CET, 18H Moscow)
...
- US Thanksgiving Holiday - No Meeting Next Week.
...
- Frameworks:
  ...
  - Aries-CloudAgent-Python [https://github.com/hyperledger/aries-cloudagent-python](https://github.com/hyperledger/aries-cloudagent-python), Meetings: [ACA-Pug Meetings](ACA-Pug-Meetings_18484272.html), Documentation: https://aca-py.org
    ...
    - Traction - [https://traction-sandbox-tenant-ui.apps.silver.devops.gov.bc.ca](https://traction-sandbox-tenant-ui.apps.silver.devops.gov.bc.ca)
  ...
  - Aries VCX ([https://github.com/hyperledger/aries-vcx](https://github.com/hyperledger/aries-vcx), Meetings: [Aries-VCX Meetings](https://lf-hyperledger.atlassian.net/wiki/display/ARIES/Community+calls)
    ...
    - repo restructuring [https://github.com/hyperledger/aries-vcx/issues/1045](https://github.com/hyperledger/aries-vcx/issues/1045)
    - start publishing generic didcomm components, built isolated pipelines &amp; versioning:
      
      - did\_doc, did\_parser, did\_resolver(s)
      - higher level abstraction ledger clients - modular indy ledger client, anoncreds resolver(s)
...
- Aries ACA-Py Plugin Repo - Jamie Hale
- Please Ack - Stephen Curran
- Purpose of Aries RFCs - Sam
  
  - Policy RFCs? (Kim suggestion)
    
    - Example - community coordinated update)
    - separation of technical vs non-technical (protocol vs non-protocol)
    - alternate: community
- LTS Policy
  
  - [https://github.com/hyperledger/aries-rfcs/pull/799](https://github.com/hyperledger/aries-rfcs/pull/799)
- Unqualified DIDs
