...
# Hyperledger Aries : 2021-06-30-B Aries Working Group Call (US afternoon)

Created by Sam Curren, last modified by Timo Glastra on Jun 30, 2021
...
## Date: 30 Jun 2021 (12PM Los Angeles, 3PM New York, Tuesday at 7AM Sydney)
...
- [2021-07-01 : Identity Implementers WG Call](https://lf-hyperledger.atlassian.net/wiki/display/IWG/2021-07-01+%3A+Identity+Implementers+WG+Call): Steve McCown (Anonyome Labs) will present on auto-generating language wrappers for Rust libraries, such as didcomm\_rs.
...
- Aries-CloudAgent-Python
  ...
  - Release 0.7.0RC-01 pending – probably today.  Honest.
...
- Pickup Protocol v2 - [PR 685](https://github.com/hyperledger/aries-rfcs/pull/685)
- Dateint representations - [PR 687](https://github.com/hyperledger/aries-rfcs/pull/687)
- Accepted Status AIP 2.0 RFCs - [PR 683](https://github.com/hyperledger/aries-rfcs/pull/683)

<!--THE END-->

- Multiple Proofs from a Request - Matt Raffel (Kiva) / Stephen Curran
  
  - Followup PR ?
- [update](https://github.com/hyperledger/aries-rfcs/pull/684) ECDH-1PU info in RFC-334 and RFC-587 [Baha A Shaaban](https://lf-hyperledger.atlassian.net/wiki/people/712020:c6fcc16a-f888-4bb1-bef3-41f4da326364?ref=confluence)
