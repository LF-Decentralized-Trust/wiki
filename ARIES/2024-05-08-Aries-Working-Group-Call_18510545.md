...
# Hyperledger Aries : 2024-05-08 Aries Working Group Call

Created by Sam Curren, last modified on May 08, 2024
...
08 May 2024 (7AM Los Angeles, 10AM New York, 3PM London, 4PM CET, 18H Moscow)
...
- Implementations:
  ...
  - Aries Cloud Agent Python [https://github.com/hyperledger/aries-cloudagent-python](https://github.com/hyperledger/aries-cloudagent-python), Meetings: [ACA-Pug Meetings](ACA-Pug-Meetings_18484272.html), Documentation: [https://aca-py.org](https://aca-py.org)
    ...
    - 0.11.1 pure patch release, updates aiohttp to address a CVE.
...
- Unqualified DIDs 
  ...
  - Update Dates?
    ...
    - Sam to update the RFC with a PR
  - did:indy handling
...
- Open Discussion
  ...
  - Indy - defining a DIDComm protocol for fetching VDR content.
    
    - send batch requests - essentially DID URLs and get them back.
    - under design now
  - Protocol RFC
