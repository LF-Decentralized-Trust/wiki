...
# Hyperledger Aries : 2023-11-08 Aries Working Group Call

Created by Sam Curren, last modified on Nov 08, 2023
...
08 Nov 2023 (7AM Los Angeles, 10AM New York, 3PM London, 4PM CET, 18H Moscow)
...
- Aries Akrida - Load Testing DIDComm based protocols
  ...
  - Prepping for transition to Hyperledger
...
- Aries marketing update - [Helen Garneau](https://lf-hyperledger.atlassian.net/wiki/people/60da2fc7285656006a667081?ref=confluence) [Alex Metcalf](https://lf-hyperledger.atlassian.net/wiki/people/70121:e519cb5b-f9e4-4e87-b5f7-bc99fea74168?ref=confluence)  
  ...
  - New logo selected this coming week - see Aries Discord Channel
...
- Draft report PR posted: (Stephen)
  
  - [https://github.com/hyperledger/toc/pull/181](https://github.com/hyperledger/toc/pull/181)
- LTS Policy
...
- DIDComm v2 Followup
  ...
  - Colton - wants it
  - Patrick - on Aries-VCX roadmap in 2024
  - stephen - love to see it, doesn't see a path to get there. not yet a priority.
  - AATH didcomm v2 support?
  - AFJ PR for DIDComm v2: [https://github.com/hyperledger/aries-framework-javascript/tree/feat/didcomm-v2](https://github.com/hyperledger/aries-framework-javascript/tree/feat/didcomm-v2)
  - possible early 2024 target
- Unqualified DIDs
...
- Please Ack question – is a ~please\_ack (OUTCOME)
- Open Discussion
