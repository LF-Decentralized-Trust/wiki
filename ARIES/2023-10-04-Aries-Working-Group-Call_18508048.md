...
# Hyperledger Aries : 2023-10-04 Aries Working Group Call

Created by Sam Curren, last modified by Stephen Curran on Oct 04, 2023
...
04 Oct 2023 (7AM Los Angeles, 10AM New York, 3PM London, 4PM CET, 18H Moscow)
...
- Frameworks:
  ...
  - Aries-CloudAgent-Python [https://github.com/hyperledger/aries-cloudagent-python](https://github.com/hyperledger/aries-cloudagent-python), Meetings: [ACA-Pug Meetings](ACA-Pug-Meetings_18484272.html), Documentation: https://aca-py.org
    ...
    - 0.10.3 has been released - patch release on 0.10.2 that adds a migration script to enable upgrading very old issuers (~0.5.2) that use revocation.
  ...
  - Aries-Framework-JavaScript [https://github.com/hyperledger/aries-framework-javascript](https://github.com/hyperledger/aries-framework-javascript), Meetings: [Framework JS Meetings](Framework-JS-Meetings_18482467.html)
    ...
    - 0.4.1 released
      ...
      - JFF Plugfest: [https://www.youtube.com/watch?v=GVNLJlFUfPM](https://www.youtube.com/watch?v=GVNLJlFUfPM)
        
        - Needs DIDComm v2 issuers and verifiers needed for next round.
...
- Aries marketing update - [Helen Garneau](https://lf-hyperledger.atlassian.net/wiki/people/60da2fc7285656006a667081?ref=confluence) [Alex Metcalf](https://lf-hyperledger.atlassian.net/wiki/people/70121:e519cb5b-f9e4-4e87-b5f7-bc99fea74168?ref=confluence)  
  ...
  - New Wiki page going live shortly: [New Hyperledger Aries Draft](/wiki/pages/createpage.action?spaceKey=ARIES&title=New%20Hyperledger%20Aries%20Draft&linkCreation=true&fromPageId=18508048)
...
- DIDComm V2 Demo: [https://demo.didcomm.org/](https://demo.didcomm.org/) ([Github Repo](https://github.com/Indicio-tech/didcomm-demo))
- Open Tasks
