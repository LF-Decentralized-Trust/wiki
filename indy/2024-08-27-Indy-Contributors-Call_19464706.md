...
# Hyperledger Indy : 2024-08-27 Indy Contributors Call

Created by Char Howland, last modified on Aug 27, 2024
...
- Indy Project updates
  ...
  - Indy repo: [https://github.com/hyperledger/indy](https://github.com/hyperledger/indy)
- Indy Read Replica progress from mentee Bryan Elee
- Updates
  ...
  - Trust DID Web
    ...
    - This work will happen at the DIF under the Identity and Discovery Working Group
    - 3 implementations (Go implementation added)
    - Merging the log feature
- Open Discussion
