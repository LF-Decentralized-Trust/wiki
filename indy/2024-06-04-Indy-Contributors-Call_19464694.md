...
# Hyperledger Indy : 2024-06-04 Indy Contributors Call

Created by Char Howland, last modified by Sean Bohan on Jun 10, 2024
...
- Ubuntu 22.04 upgrade
  ...
  - Hoping to finish Indy build process this week
  - Debugging build issues
  - Created PR for Indy plenum to update Python versioning
- Ledger Redaction follow-up discussion
- [Indy Besu](https://github.com/hyperledger/indy-besu) updates and discussion
- Open Discussion
