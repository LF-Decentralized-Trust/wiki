...
# Community Architects : Solang checklist

Created by Ry Jones, last modified by David Boswell on Oct 07, 2022
...
- Set up Wiki space using project space (To be created in the meantime use the [Sample Project Page](/wiki/pages/createpage.action?spaceKey=CA&title=Sample%20Project%20Page&linkCreation=true&fromPageId=20549242) as the home page in a blank space). Name the space `projectname` all lower case.
...
- License Scan (happens quarterly, reminder to not forget)
- DCO Scan
- Is a security audit needed? (not now - verifying with [Hart Montgomery](https://lf-hyperledger.atlassian.net/wiki/people/712020:86f447c0-86dc-43b3-ac03-6a31923bbb84?ref=confluence))
...
- Create an event on the new working group's calendar to remind the subscribers that their TSC update is due (see [example](https://lists.hyperledger.org/g/explorer/addevent?eventid=352423&repeatid=0&calstart=2018-12-06)) (Third Thursday every quarter, starting in Feb 2023)
...
- Work with the marketing team to develop a project-specific webpage (see [example](https://docs.google.com/document/d/1T3GcfzLXY1PNi6sgXpPDufWlpqGzIFHjg4ejdoVnVbE/edit))
  ...
  - Add project to landscape so it shows up on the project listing on the site
