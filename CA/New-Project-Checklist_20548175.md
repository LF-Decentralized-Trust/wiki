...
# Community Architects : New Project Checklist

Created by Tracy Kuhrt, last modified by David Boswell on Mar 28, 2024
...
- Set up Wiki space using project space (To be created in the meantime use the [Sample Project Page](/wiki/pages/createpage.action?spaceKey=CA&title=Sample%20Project%20Page&linkCreation=true&fromPageId=20548175) as the home page in a blank space). Name the space `projectname` all lower case.
