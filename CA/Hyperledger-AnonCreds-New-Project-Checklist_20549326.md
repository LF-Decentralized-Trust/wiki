...
# Community Architects : Hyperledger AnonCreds New Project Checklist

Created by Stephen Curran, last modified by Ry Jones on Nov 14, 2022
...
- Set up Wiki space using project space (To be created in the meantime use the [Sample Project Page](/wiki/pages/createpage.action?spaceKey=CA&title=Sample%20Project%20Page&linkCreation=true&fromPageId=20549326) as the home page in a blank space). Name the space `projectname` all lower case.
