...
# Hyperledger AnonCreds : 2023-03-27 AnonCreds Specification Working Group Meeting

Created by Stephen Curran, last modified on Mar 27, 2023
...
- [PRs](https://github.com/hyperledger/anoncreds-spec/pulls) for review and merging
  ...
  - There are is a backlog of issues to be applied to the AnonCreds spec – mostly assigned to [Stephen Curran](https://lf-hyperledger.atlassian.net/wiki/people/557058:d676f135-ecd6-465b-b7eb-f87976bf4569?ref=confluence)
...
![](images/icons/bullet_blue.gif) [dummyfile.txt](attachments/20292112/20295126.txt) (text/plain)
